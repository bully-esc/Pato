...
<script>
  ...
  // Contador fecha apertura 
  function updateTimer() {
    const startDate = new Date("2023-04-02T00:00:00").getTime();
    const now = Date.now();
  ...
  // Animación  de corazón se saco de canvas (placeholder)
